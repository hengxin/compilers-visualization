...
public class GenTreeParseTreeListener implements ParseTreeListener {
    ...
    public void visitTerminal(TerminalNode node) {
        parserResult.addParserState(ParserState.newBuilder().setRoot(toTreeNodeUtils.toTree(node)));
    }

    @Override
    public void enterEveryRule(ParserRuleContext ctx) {
        parserResult.addParserState(ParserState.newBuilder().setRoot(toTreeNodeUtils.toTree(ctx)));
    }
